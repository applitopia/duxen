...
var _CommonEngine = _interopRequireDefault(require("./CommonEngine"));
...
var _StateEngine2 = _interopRequireDefault(require("./StateEngine"));
...
var RepoEngine =
/*#__PURE__*/
function (_StateEngine) {
  _inherits(RepoEngine, _StateEngine);

  function RepoEngine(schema) {
    _classCallCheck(this, RepoEngine);

    return _possibleConstructorReturn(this, _getPrototypeOf(RepoEngine).call(this, schema));
  }

  _createClass(RepoEngine, [{
    key: "repoReducer",
    value: function repoReducer() {
      var stateReducer = _get(_getPrototypeOf(RepoEngine.prototype), "stateReducer", this).call(this);
          ...
          case 'DUXEN_INIT':
            {
              ...
              mutableRepo.set("branches", (0, _immutableSorted.fromJS)({
                'master': rbp
              }));
              break;
            }
...
var _CommonEngine2 = _interopRequireDefault(require("./CommonEngine"));
...
var StateEngine =
/*#__PURE__*/
function (_CommonEngine) {
  _inherits(StateEngine, _CommonEngine);

  function StateEngine(schema) {
    _classCallCheck(this, StateEngine);

    return _possibleConstructorReturn(this, _getPrototypeOf(StateEngine).call(this, schema));
  } //
  // Compile the reducer
  //
  ...
  _createClass(StateEngine, [{
    ...
    value: function stateReducer() {
      ...
      var validateAction = function validateAction(action) {
        ...
        if (_this._getNameType(action.collName) !== 'collection') {
      ...
      var updateDependentsList = function updateDependentsList(mutableState, state, deps) {
        for (var i = 0, length = deps.length; i < length; i++) {
          ...
          switch (dcn.type) {
            case 'formula':
              {
                var fcne = cast(dcn.schemaEntry); // Prepare props
            ...
            case 'view':
              {
                ...
                var scn = getCompiledName(dcn.namePrefix + vcne.sourceName); // Prepare props
                ...
                for (var _pi = 0, _len = vcne.props.length; _pi < _len; _pi++) {
                  ...
                  switch (_typeof(_propName)) {
                    ...
                    default:
                      {
                        throw new Error("Invalid type of propName: " + _typeof(_propName));
                      }
                  }
                }
...
var _SubActionFactory = _interopRequireDefault(require("./SubActionFactory"));
...
function () {
  function SubEngine(engine, subSchemaPath) {
    ...
    this._subSchemaPath = subSchemaPath;
    this._prefix = subSchemaPath + '.';
    this._actionFactory = new _SubActionFactory["default"](this._engine.actionFactory(), this._subSchemaPath);
  } // Extract a value from state
...
function () {
  ...
  _createClass(Seqen, [{
    ...
    key: "insert",
    value: function insert(sortedMap, k, v, props) {
      var seq = _immutableSorted.Seq.Keyed([[k, v]]);

      return this.insertSeq(sortedMap, seq, props);
    }
  }, {
    key: "insertSeq",
    value: function insertSeq(sortedMap, seq, props) {
      var seq2 = this.process(seq, props);
      return sortedMap.withMutations(function (mutable) {
        return seq2.forEach(function (v, k) {
          return mutable.set(k, v);
        });
      });
    }
  }, {
    key: "delete",
    value: function _delete(sortedMap, k, v, props) {
      var seq = _immutableSorted.Seq.Keyed([[k, v]]);
    ...
    key: "deleteSeq",
    value: function deleteSeq(sortedMap, seq, props) {
      var seq2 = this.process(seq, props);
      return sortedMap.withMutations(function (mutable) {
        return seq2.forEach(function (v, k) {
          return mutable["delete"](k);
        });
      });
    }
  }]);
...
},{"immutable-sorted":11}],14:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
Object.defineProperty(exports, "Seqen", {
  enumerable: true,
  get: function get() {
    return _SeqenMain["default"];
  }
});
exports["default"] = void 0;

var _SeqenMain = _interopRequireDefault(require("./SeqenMain"));
